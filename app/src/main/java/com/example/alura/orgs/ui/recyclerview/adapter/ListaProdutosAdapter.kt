package com.example.alura.orgs.ui.recyclerview.adapter
...
class ListaProdutosAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        fun vincula(produto: Produto){
            ...
            val descricacao = itemView.findViewById<TextView>(R.id.produto_item_descricao)
            descricacao.text = produto.descricao
